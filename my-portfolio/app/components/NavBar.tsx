  ...
  return (
    <>
      ...
      >
        ...
        <ul
          ref={slideMenuRef}
          className={`md:hidden text-lg flex flex-col fixed top-0 bottom-0 gap-16 w-64 -right-64 px-10 py-20 h-screen bg-[#fff5f5] bg-opacity-70 backdrop-blur-md transition duration-500 dark:bg-darkHover/70 dark:text-white`}
        >
