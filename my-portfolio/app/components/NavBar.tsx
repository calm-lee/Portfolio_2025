  ...
  return (
    <>
      ...
      >
        ...
        <ul
          ref={slideMenuRef}
          className={`md:hidden flex flex-col fixed top-0 bottom-0 gap-4 w-64 -right-64 px-10 py-20 h-screen bg-rose-50 transition duration-500 dark:bg-darkHover dark:text-white`}
        >
